        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img">
                        <img class="img-fluid" src="../img/Copy Paste Data Entry Services.jpg">
                    </div>
                </div>
        ...
        <div class="container pt-5">
            <div class="row g-5">
                <div class="col-lg-6 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <h4 class="text-white mb-4">Security and Data Encryption</h4>
                    <p class="text-light mb-4">Our data copy-paste process strictly adheres the stringent data security protocols and measures to safeguard customer data. All of our staff members are thoroughly screened and agreed on non-disclosure documents before the commencement of any project. </p>

                    <h4 class="text-white mb-4">Top-notch Infrastructure</h4>
                    <p class="text-white mb-4">Our company is backed by a strong infrastructure and high-tech systems to achieve faster turnaround times as compared to other copy-paste service vendors. </p>
        ...
        <div class="container pt-5">
            <div class="row g-5">
                ...
                <div class="col-lg-6 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h4 class="text-white mb-4">Quick TAT</h4>
                    <p class="text-white mb-4">Time is an important factor for all organisations, no matter whether you are running a small or a big firm time management is much more important. To keep this fact in mind we define our work allocation procedures ensuring not cross the deadlines set by our clients</p>

                    <h4 class="text-white mb-4">Skilled expert for copy-paste data entry service</h4>
                    <p class="text-white mb-4">This is the greatest benefit of outsourcing copy-paste service you will get dedicated, trained, and qualified data entry operators for your data according to your requirements. </p>

                    <h4 class="text-white mb-4">Transparent Communication</h4>
                    <p class="text-white mb-4">Communication between the client and copy-paste data entry service provider is crucial for successful work partnerships. Transparency in the messages makes sure that all of your requirements are interpreted correctly to data entry provider before the start of copy-paste services. Moreover, we keep on informing you about the status of your copy-paste project throughout the outsourcing process. </p>

                    <h4 class="text-white mb-4">Satisfied Customer</h4>
                    <p class="text-white mb-4">Our clients' contentment is the heart of our data entry service company. So, to fulfil their needs and to add their success stories drive us to enhance the working progress. Thus, to make them happy is our priority. </p>

                    <p class="text-white mb-4">All in all, you will be happy to receive all our coy paste services. Plus, you can get in touch with our customer support team anytime to learn about our other data entry services at affordable rates.
                        
                    </p>
                    <p class="text-white mb-4">Grab the offer of a free sample run of our copy-paste services to understand the process and the output ratio.</p>
                </div>
            </div>
        </div>
    </div>
