...
<body>
  ...
  <div class="container">
    ...
    <ul class="mb-4">
      <li>Terms and conditions of the data entry contract</li>
      <li>Data volume</li>
      <li>Personalized support on weekends</li>
      <li>Deadline for completing the project</li>
      <li>Skill requirements of our data entry resources</li>
      <li>Project complexity</li>
      <li>Resources and technology consumption</li>
    </ul>
    ...
    <br><br>
    <p class="mb-4"><b>Note: </b> the Man-Month Pricing Plan, a dedicated resource work is for 8 hours in a day and 6 days in a week (Monday to Saturday) total of 192 hours in a month.</p>
  ...
  <ul class="mb-4">
    ...
    <li>Data Entry Hourly Rate: You pay only for the number of working hours in a week</li>
    <li>Monthly Rate for Data Entry: Here you pay for work done 5 days a week, 8 hours per day, and a total of 160 hours per month</li>
    <li>24/7 Coverage Rate: Businesses with heavy work volume are allowed to choose this option. Here you need to pay for 30 days at 24 hours per day, with a total of 720 hours</li>
    <li>Keystroke Rate for Data Entry: This is the pricing selection parameter that is charged as per every 65-character line with spaces</li>
  </ul>
