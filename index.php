        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    <p class="display-4 text-white mb-4 animated slideInRight" style="font-size: 275%">
                        <b>Perfectionist at Every Level</b>
                    </p>
                    <p class="text-white mb-4 animated slideInRight" style="
                            font-size: 18px;
                            ">
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow animate__animated animate__fadeInLeft" data-wow-delay="0.1s">
                    <div class="about-img">
                        <img class="img-fluid" src="img/comprehensive.jpeg" alt="Working Image" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid bg-primary feature pt-5 ">
        <div class="container pt-5">
            ...
            <div class="row g-5 hero-header ">
                ...
                <div class="col-lg-6 align-self-end text-center text-md-end wow animate__animated animate__fadeInLeft" data-wow-delay="0.5s">
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img wow animate__animated animate__fadeInRight" data-wow-delay="0.5s">
                        <img class="img-fluid" src="img/03.png" alt="Working Image" />
                    </div>
                    <br /><br />
                </div>
                <!-- Left Text -->
                <div class="col-lg-6 wow animate__animated animate__slideInLeft" data-wow-delay="0.5s">
                    ...
                    <ul class="custom-list mb-4 text-dark" style="
                            text-align: justify;
                            font-family: 'Gill Sans', 'Gill Sans MT', Calibri,
                            'Trebuchet MS', sans-serif;
                            font-size: 18px;
                ...
                <div class="col-lg-6 wow animate__animated animate__fadeInLeft" data-wow-delay="0.1s">
                    <div class="about-img">
                        <img class="img-fluid" src="img/02.png" alt="Working Image" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5 hero-header">
                <div class="col-lg-6 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <div class="row g-4 pt-3">
                        ...
                        <div class="col-sm-6 wow animate__animated animate__slideInLeft" data-wow-delay="0.4s">
                            <div class="d-flex rounded p-3" style="background: rgba(256, 256, 256, 0.1)">
                        ...
                        <div class="col-sm-6 wow animate__animated animate__slideInLeft" data-wow-delay="0.5s">
                            <div class="d-flex rounded p-3" style="background: rgba(256, 256, 256, 0.1)">
                        ...
                        <div class="col-sm-6 wow animate__animated animate__slideInLeft" data-wow-delay="0.6s">
                            <div class="d-flex rounded p-3" style="background: rgba(256, 256, 256, 0.1)">
                ...
                <div class="col-lg-6">
                    <div class="accordion" id="accordionFAQ1">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="0.5s">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionFAQ1">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="0.6s">
                            ...
                            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionFAQ1">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="0.7s">
                            ...
                            <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionFAQ1">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="0.8s">
                            ...
                            <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#accordionFAQ1">
                                <div class="accordion-body">
                ...
                <div class="col-lg-6">
                    <div class="accordion" id="accordionFAQ2">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="1.0s">
                            ...
                            <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen" data-bs-parent="#accordionFAQ2">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="1.1s">
                            ...
                            <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven" data-bs-parent="#accordionFAQ2">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="1.2s">
                            ...
                            <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingTwelve" data-bs-parent="#accordionFAQ2">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="1.3s">
                            ...
                            <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen" data-bs-parent="#accordionFAQ2">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="1.4s">
                            ...
                            <div id="collapseFourteen" class="accordion-collapse collapse" aria-labelledby="headingFourteen" data-bs-parent="#accordionFAQ2">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="1.5s">
                            ...
                            <div id="collapseFifteen" class="accordion-collapse collapse" aria-labelledby="headingFifteen" data-bs-parent="#accordionFAQ2">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="1.6s">
                            ...
                            <div id="collapseSixteen" class="accordion-collapse collapse" aria-labelledby="headingSixteen" data-bs-parent="#accordionFAQ2">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item wow fadeIn" data-wow-delay="1.7s">
                            ...
                            <div id="collapseSeventeen" class="accordion-collapse collapse" aria-labelledby="headingSeventeen" data-bs-parent="#accordionFAQ2">
                                <div class="accordion-body">
